                              ...
                              uint8_t ExtTRGFilter)
{
  ...
  TIM1->SMCR = (uint8_t)((uint8_t)(TIM1->SMCR & (uint8_t)(~(uint8_t)(TIM1_SMCR_SMS | TIM1_SMCR_TS))) | (uint8_t)((uint8_t)TIM1_SLAVEMODE_EXTERNAL1 | TIM1_TS_ETRF));
}
...
/**
  * @brief  Enables or Disables the TIM1閹讹拷 Hall sensor interface.
...
/**
  * @brief  Selects the TIM1閹讹拷 One Pulse Mode.
...
void TIM1_CounterModeConfig(TIM1_CounterMode_TypeDef TIM1_CounterMode)
{
  ...
  TIM1->CR1 = (uint8_t)((uint8_t)(TIM1->CR1 & (uint8_t)((uint8_t)(~TIM1_CR1_CMS) & (uint8_t)(~TIM1_CR1_DIR))) | (uint8_t)TIM1_CounterMode);
}
...
void TIM1_ForcedOC4Config(TIM1_ForcedAction_TypeDef TIM1_ForcedAction)
{
  ...
  /* Reset the OCM Bits & Configure the Forced output Mode */
  TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_OCM)) | (uint8_t)TIM1_ForcedAction);
}
...
void TIM1_SelectOCxM(TIM1_Channel_TypeDef TIM1_Channel, TIM1_OCMode_TypeDef TIM1_OCMode)
{
  ...
  else
  {
    ...
    /* Reset the Output Compare Bits & Set the Output Compare Mode */
    TIM1->CCMR4 = (uint8_t)((uint8_t)(TIM1->CCMR4 & (uint8_t)(~TIM1_CCMR_OCM)) | (uint8_t)TIM1_OCMode);
  }
}
...
/**
  * @brief  Clears the TIM1閹讹拷 pending flags.
...
void TIM1_ClearFlag(TIM1_FLAG_TypeDef TIM1_FLAG)
{
  ...
  /* Clear the flags (rc_w0) clear this bit by writing 0. Writing 閿燂拷1閿燂拷 has no effect*/
